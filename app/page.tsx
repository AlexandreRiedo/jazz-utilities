    ...
    <>
      ...
      lg:w-full lg:flex lg:flex-col lg:justify-center lg:items-center lg:h-auto lg:overflow-x-clip">
        ...
        lg:grid lg:grid-cols-[1fr_auto_auto] lg:gap-8 lg:items-start">
            ...
            {/* Randomize Button */}
            <div onClick={triggerRandomGeneration} className="relative flex flex-col justify-end py-8 w-full mt-8  px-4 border-y-0 border-panel-border bg-[#ffa7b6]
          lg:my-0 lg:bg-transparent">
              <button className="px-8 py-2 bg-accent-red border-2 border-stone-900 font-neobrutalist font-[450] text-[1.75rem] text-stone-900/90 shadow-[8px_8px_var(--color-stone-900)]
            ...
            {/* Edit Metronome */}
            <div className="relative flex flex-col justify-end py-8 w-full px-4 border-y-0 border-panel-border bg-[#ff95c5]
           lg:bg-transparent">
              <div className="bg-accent-pink border-2 border-b-0 border-stone-900 font-neobrutalist font-[450] text-[1.75rem] text-stone-900/90 shadow-[8px_8px_var(--color-stone-900)]">
            ...
            {/* Options */}
            <div className="relative flex flex-col justify-end py-8 px-4 border-y-0 border-panel-border bg-[hsl(30,100%,89%)]
           lg:bg-transparent lg:w-auto">
              <div className="bg-accent-amber border-2 border-b-0 border-stone-900 font-neobrutalist font-[450] text-[1.75rem] text-stone-900/90 shadow-[8px_8px_var(--color-stone-900)]
            ">
                <details className="open:border-b-2">

                  {/* Button To Open */}
                  <summary className="px-8 py-2 text-center hover:bg-amber-hover border-b-2 border-stone-900 cursor-pointer">Options</summary>
